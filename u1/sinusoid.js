...
function drawTriangle(ctx, ground, a, b, color){
    ctx.beginPath();
    ctx.fillStyle = color;
    ctx.moveTo(0,0);
    ctx.lineTo(ground,0);
...
function startSimulation(){
    ...
    try {
        animate(Defaults.aLink, Defaults.bLink, Defaults.cLink, Defaults.dLink,
                [ {x1:0, y1:0, x2:0, y2:0} ], Defaults.triSpecs, Defaults.rotationProps,
                canvas, ctx, startTime);
    } catch(e) {
        alert(e);
    }
}
...
function loadSimulation(){
    document.getElementById("speed").defaultValue      = Defaults.rotationProps.speed;
    document.getElementById("triangle_a").defaultValue = Defaults.triSpecs.a;
    document.getElementById("triangle_b").defaultValue = Defaults.triSpecs.b;
/*
    document.getElementById("speed").defaultValue = Defaults.rotationSpeed;
    document.getElementById("speed").defaultValue = Defaults.rotationSpeed;
    document.getElementById("speed").defaultValue = Defaults.rotationSpeed;
    document.getElementById("speed").defaultValue = Defaults.rotationSpeed;
*/
...
function applyValues(){
    Defaults.rotatioProps.speed = document.getElementById("speed").value;     
    Defaults.triSpecs.a = document.getElementById("triangle_a").value;
    Defaults.triSpecs.b = document.getElementById("triangle_b").value;
}
